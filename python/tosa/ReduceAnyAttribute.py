...
def ReduceAnyAttributeStart(builder):
    builder.StartObject(1)

def Start(builder):
    ReduceAnyAttributeStart(builder)

def ReduceAnyAttributeAddAxis(builder, axis):
    builder.PrependInt32Slot(0, axis, 0)

def AddAxis(builder, axis):
    ReduceAnyAttributeAddAxis(builder, axis)

def ReduceAnyAttributeEnd(builder):
    return builder.EndObject()

def End(builder):
    return ReduceAnyAttributeEnd(builder)
