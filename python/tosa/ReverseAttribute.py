...
def ReverseAttributeStart(builder):
    builder.StartObject(1)

def Start(builder):
    ReverseAttributeStart(builder)

def ReverseAttributeAddAxis(builder, axis):
    builder.PrependInt32Slot(0, axis, 0)

def AddAxis(builder, axis):
    ReverseAttributeAddAxis(builder, axis)

def ReverseAttributeEnd(builder):
    return builder.EndObject()

def End(builder):
    return ReverseAttributeEnd(builder)
