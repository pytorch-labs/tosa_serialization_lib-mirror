...
def FFT2dAttributeStart(builder):
    builder.StartObject(2)

def Start(builder):
    FFT2dAttributeStart(builder)

def FFT2dAttributeAddInverse(builder, inverse):
    builder.PrependBoolSlot(0, inverse, 0)

def AddInverse(builder, inverse):
    FFT2dAttributeAddInverse(builder, inverse)

def FFT2dAttributeAddLocalBound(builder, localBound):
    builder.PrependBoolSlot(1, localBound, 0)

def AddLocalBound(builder, localBound):
    FFT2dAttributeAddLocalBound(builder, localBound)

def FFT2dAttributeEnd(builder):
    return builder.EndObject()

def End(builder):
    return FFT2dAttributeEnd(builder)
